...
double Black_Scholes::call(double current_price, double strike_price, double time_expiration, double risk_free_interest_rate, double volatility){
    int n1 = d1(current_price, strike_price, time_expiration, risk_free_interest_rate, volatility);

    int n2 = d2(current_price, strike_price, time_expiration, risk_free_interest_rate, volatility, n1);

    int result = (current_price*n1)-(strike_price*(std::exp((-time_expiration*risk_free_interest_rate)))*n2);
...
double Black_Scholes::put(double current_price, double strike_price, double time_expiration, double risk_free_interest_rate, double volatility){
    ...
    int n2 = d2(current_price, strike_price, time_expiration, risk_free_interest_rate, volatility);

    int result = (strike_price*(std::exp((-time_expiration*risk_free_interest_rate)))*n2)-(current_price*n1);
