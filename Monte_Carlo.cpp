...
double put(double s, double k, double r, double T, double V)
{
    double fp = std::exp(-r * T);

    double sp = second_part_put(s, k, r, T, V);
}

double second_part_put(double s, double k, double r, double T, double V)
{
    std::random_device rd;
